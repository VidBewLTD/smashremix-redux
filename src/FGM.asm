...
scope FGM {
    ...
    add_sound(Crash/sounds/YEEHAW, SAMPLE_RATE_16000, FGM_TYPE_VOICE, 0, -1)
    add_sound(DrMario/sounds/YEEHAW, SAMPLE_RATE_16000, FGM_TYPE_VOICE, 0, -1)
    add_sound(DMarina/sounds/ANNOUNCER, SAMPLE_RATE_16000, FGM_TYPE_VOICE, 40, -1)
    add_sound(DMarina/sounds/SHAKE, SAMPLE_RATE_16000, FGM_TYPE_VOICE, 0, -1)
    add_sound(DMarina/sounds/HOI, SAMPLE_RATE_16000, FGM_TYPE_VOICE, 0, -1)
    add_sound(DMarina/sounds/TAUNT, SAMPLE_RATE_16000, FGM_TYPE_VOICE, 0, -1)
    add_sound(DMarina/sounds/YAHOO, SAMPLE_RATE_16000, FGM_TYPE_VOICE, 0, -1)
    add_sound(DMarina/sounds/HO, SAMPLE_RATE_16000, FGM_TYPE_VOICE, 0, -1)
    add_sound(DMarina/sounds/YAH, SAMPLE_RATE_16000, FGM_TYPE_VOICE, 0, -1)
    add_sound(DMarina/sounds/YAAAH, SAMPLE_RATE_16000, FGM_TYPE_VOICE, 0, -1)
    add_sound(DMarina/sounds/TORIYA, SAMPLE_RATE_16000, FGM_TYPE_VOICE, 0, -1)
    add_sound(DMarina/sounds/PAIN, SAMPLE_RATE_16000, FGM_TYPE_VOICE, 0, -1)
    add_sound(DMarina/sounds/KO, SAMPLE_RATE_16000, FGM_TYPE_VOICE, 0, -1)
    add_sound(DMarina/sounds/STARKO, SAMPLE_RATE_16000, FGM_TYPE_VOICE, 0, -1)
    add_sound(DMarina/sounds/SIGH, SAMPLE_RATE_16000, FGM_TYPE_SLEEP, 0, 0x120)
    add_sound(DMarina/sounds/THRUSTER, SAMPLE_RATE_16000, FGM_TYPE_VOICE, 40, -1)
    add_sound(DMarina/sounds/STUNLOOP, SAMPLE_RATE_16000, FGM_TYPE_VOICE, 0, -1)
    add_sound(DMarina/sounds/VICTORY, SAMPLE_RATE_16000, FGM_TYPE_VOICE, 0, -1)
    add_sound(DMarina/sounds/SFX_POP, SAMPLE_RATE_16000, FGM_TYPE_VOICE, 0, -1)
    add_sound(DMarina/sounds/SFX_SHAKE, SAMPLE_RATE_32000, FGM_TYPE_VOICE, 0, -1)
    add_sound(DMarina/sounds/SFX_ENTRY, SAMPLE_RATE_32000, FGM_TYPE_VOICE, 0, -1)
    add_sound(music/instruments/marimba-0, SAMPLE_RATE_32000, FGM_TYPE_VOICE, 0, -1)
    add_sound(Lamb/sounds/ANNOUNCER, SAMPLE_RATE_16000, FGM_TYPE_VOICE, 40, -1)
    add_sound(Lamb/sounds/ATTACK, SAMPLE_RATE_16000, FGM_TYPE_VOICE, 0, -1)
    add_sound(Lamb/sounds/ATTACK2, SAMPLE_RATE_16000, FGM_TYPE_VOICE, 0, -1)
    add_sound(Lamb/sounds/ATTACK3, SAMPLE_RATE_16000, FGM_TYPE_VOICE, 0, -1)
    add_sound(Lamb/sounds/BAAA, SAMPLE_RATE_16000, FGM_TYPE_VOICE, 0, -1)
    add_sound(Lamb/sounds/BELL, SAMPLE_RATE_16000, FGM_TYPE_VOICE, 0, -1)
    add_sound(Lamb/sounds/CLIFFGRAB, SAMPLE_RATE_16000, FGM_TYPE_VOICE, 0, -1)
    add_sound(Lamb/sounds/DAMAGE, SAMPLE_RATE_16000, FGM_TYPE_VOICE, 0, -1)
    add_sound(Lamb/sounds/DAMAGERARE, SAMPLE_RATE_16000, FGM_TYPE_VOICE, 0, -1)
    add_sound(Lamb/sounds/HEAVYGRAB, SAMPLE_RATE_16000, FGM_TYPE_VOICE, 0, -1)
    add_sound(Lamb/sounds/JUMP, SAMPLE_RATE_16000, FGM_TYPE_VOICE, 0, -1)
    add_sound(Lamb/sounds/KO, SAMPLE_RATE_16000, FGM_TYPE_VOICE, 0, -1)
    add_sound(Lamb/sounds/MEDIUM_SWORD_HIT, SAMPLE_RATE_16000, FGM_TYPE_VOICE, 50, -1)
    add_sound(Lamb/sounds/ROLL, SAMPLE_RATE_16000, FGM_TYPE_VOICE, 0, -1)
    add_sound(Lamb/sounds/SHIELD_BREAK, SAMPLE_RATE_16000, FGM_TYPE_VOICE, 0, -1)
    add_sound(Lamb/sounds/SMALL_HIT, SAMPLE_RATE_16000, FGM_TYPE_VOICE, 30, -1)
    add_sound(Lamb/sounds/SMALL_SWORD_HIT, SAMPLE_RATE_16000, FGM_TYPE_VOICE, 40, -1)
    add_sound(Lamb/sounds/STRONG_SWORD_HIT, SAMPLE_RATE_16000, FGM_TYPE_VOICE, 60, -1)
    add_sound(Lamb/sounds/STUN, SAMPLE_RATE_16000, FGM_TYPE_VOICE, 0, -1)
    add_sound(Sheik/sounds/SLEEP, SAMPLE_RATE_32000, FGM_TYPE_SLEEP, 0, 0x120)
    add_sound(Lamb/sounds/TEETER, SAMPLE_RATE_16000, FGM_TYPE_VOICE, 0, -1)
    add_sound(Lamb/sounds/WALK, SAMPLE_RATE_16000, FGM_TYPE_VOICE, 0, -1)
    add_sound(Goat/sounds/ANNOUNCER, SAMPLE_RATE_16000, FGM_TYPE_VOICE, 40, -1)
    add_sound(Goat/sounds/TAUNT, SAMPLE_RATE_16000, FGM_TYPE_VOICE, 0, -1)
    add_sound(Goat/sounds/ATTACK, SAMPLE_RATE_16000, FGM_TYPE_VOICE, 0, -1)
    add_sound(Goat/sounds/ATTACK2, SAMPLE_RATE_16000, FGM_TYPE_VOICE, 0, -1)
    add_sound(Goat/sounds/CHAIN_ATTACK, SAMPLE_RATE_16000, FGM_TYPE_VOICE, 40, -1)
    add_sound(Goat/sounds/DAMAGE, SAMPLE_RATE_16000, FGM_TYPE_VOICE, 0, -1)
    add_sound(Goat/sounds/KO, SAMPLE_RATE_16000, FGM_TYPE_VOICE, 0, -1)
    add_sound(Goat/sounds/SHIELD_BREAK, SAMPLE_RATE_16000, FGM_TYPE_VOICE, 0, -1)
    add_sound(Wolf/sounds/WOLF_STUNNED, SAMPLE_RATE_32000, FGM_TYPE_VOICE, 0, -1)
    add_sound(Ganondorf/sounds/GNDSLEEP, SAMPLE_RATE_32000, FGM_TYPE_SLEEP, 0, 0x180)
    add_sound(Goat/sounds/STRONG_ATTACK, SAMPLE_RATE_16000, FGM_TYPE_VOICE, 0, -1)
    add_sound(Goat/sounds/VICTORY_LAUGH, SAMPLE_RATE_16000, FGM_TYPE_VOICE, 0, -1)
    add_sound(Adorabat/sounds/ANNOUNCER, SAMPLE_RATE_16000, FGM_TYPE_VOICE, 40, -1)
